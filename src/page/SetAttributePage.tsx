...
import { faBan, faCheck, faTriangleExclamation, faSquareXmark, faSquareCheck, faSquareMinus } from '@fortawesome/free-solid-svg-icons';
                        ...
                        /> */}
                                            ...
                                            </div>
                                            {
                                                (getCheckStatusNum(panelDataset[comp]) === 1) ?
                                                    <FontAwesomeIcon icon={faSquareCheck} color="green" style={{ width: 16 }} size="4x" />
                                                    : (getCheckStatusNum(panelDataset[comp]) === 2) ?
                                                        <FontAwesomeIcon icon={faSquareXmark} color="red" style={{ width: 16 }} size="4x" />
                                                        : <FontAwesomeIcon icon={faSquareMinus} color="orange" style={{ width: 16 }} size="4x" />
